...
<head>
	...
	<script type="text/javascript" src="container_main.js"></script>
	<title>Vignola Import Project - Modulo Container</title>
</head>
<body>
	...
	Ext.EventManager.onDocumentReady(container_main);
	</script>
